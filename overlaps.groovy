...
Rectangle rectangle1 = new Rectangle(upLeft, downRight)

println("Enter coordinates separated by a comma (i.e. 100,20): ")
str = System.console().readLine()
upLeft = new Point(str)

println("Enter coordinates separated by a comma (i.e. 100,20): ")
str = System.console().readLine()
downRight = new Point(str)

Rectangle rectangle2 = new Rectangle(upLeft, downRight)

println("Enter coordinates separated by a comma (i.e. 100,20): ")
str = System.console().readLine()
Point query = new Point(str)

boolean insideBoth = rectangle1.within(query) && rectangle2.within(query)
